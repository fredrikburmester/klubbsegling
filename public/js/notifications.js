			...
			function n(t) {
				return (
					...
					t.onclick &&
						...
						(console.warn(
							'Notification on click must be a function.'
						),
						(t.onclick = c.onclick)),
					...
					((0, o.isString)(t.theme) && 0 !== t.theme.length) ||
						(console.warn(
							'Notification theme must be a string with length'
						),
						(t.theme = c.theme)),
					t
				)
					...
					function () {
						...
						if (
							((0, o.isString)(e) &&
								...
								(0, o.append)(
									a,
									(0, o.createParagraph)('ncf-title')(e)
								),
							(0, o.isString)(i) &&
								i.length &&
								(0, o.append)(
									a,
									(0, o.createParagraph)('nfc-message')(i)
								),
							(0, o.append)(c, a),
