	...
	})()(
		{
														...
														value: function () {
															...
															;(this._targetState =
																...
																(this._easing =
																	m(b, f))
															var w = t.filters
															for (var O in ((this._filters.length = 0),
															w))
																w[O].doesApply(
																	this
																) &&
							...
							function (t, n, e) {
								...
								var v = function (t) {
									...
									x = function (t) {
										...
										return Object.keys(n).some(function (
											t
										) {
			...
			2: [
				function (require, module, exports) {
					...
					Circle.prototype._pathString = function _pathString(opts) {
						...
						if (
							opts.trailWidth &&
							opts.trailWidth > opts.strokeWidth
						) {
					...
					Circle.prototype._trailString = function _trailString(
						opts
					) {
			...
			3: [
				function (require, module, exports) {
					...
					Line.prototype._initializeSvg = function _initializeSvg(
						svg,
						opts
					) {
			...
			5: [
				function (require, module, exports) {
					...
					Path.prototype.animate = function animate(
						progress,
						opts,
						cb
					) {
						...
						this._tweenable
							.tween({
								...
								easing: shiftyEasing,
								step: function (state) {
									self.path.style.strokeDashoffset =
										state.offset
					...
					Path.prototype._progressToOffset =
						function _progressToOffset(progress) {
							var length = this.path.getTotalLength()
					...
					Path.prototype._resolveFromAndTo =
						function _resolveFromAndTo(progress, easing, opts) {
					...
					Path.prototype._calculateFrom = function _calculateFrom(
						easing
					) {
			...
			6: [
				function (require, module, exports) {
					...
					SemiCircle.prototype._initializeSvg =
						function _initializeSvg(svg, opts) {
					...
					SemiCircle.prototype._pathString =
						Circle.prototype._pathString
					SemiCircle.prototype._trailString =
						Circle.prototype._trailString
			...
			7: [
				function (require, module, exports) {
					...
					Shape.prototype.animate = function animate(
						progress,
						opts,
						cb
					) {
					...
					Shape.prototype._createSvgView = function _createSvgView(
						opts
					) {
					...
					Shape.prototype._createPathElement =
			...
			8: [
				function (require, module, exports) {
					...
					Square.prototype._trailString = function _trailString(
						opts
					) {
						var w = 100 - opts.strokeWidth / 2
						...
						return utils.render(this._trailTemplate, {
							...
							halfOfStrokeWidth: opts.strokeWidth / 2,
							startMargin:
								opts.strokeWidth / 2 - opts.trailWidth / 2,
						})
					}
